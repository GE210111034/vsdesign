...
function registerAtaSupport() {
    ...
    return (0, dependentRegistration_1.conditionalRegistration)([
        ...
        return vscode.Disposable.from(vscode.workspace.registerFileSystemProvider('vscode-global-typings', new memFs_1.MemFs(), {
            isCaseSensitive: true,
            isReadonly: false
        }), vscode.workspace.registerFileSystemProvider('vscode-node-modules', new autoInstallerFs_1.AutoInstallerFs(), {
            isCaseSensitive: true,
            isReadonly: false
        }));
    });
